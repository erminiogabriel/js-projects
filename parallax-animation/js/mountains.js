...
class Mountain{
    ...
    generate_mountain(){
        ...
        var height = Math.random() * this.height_max;
    ...
    generate_next_height(height){
        ...
        var next_height = height + this.slope;
    ...
    update_map(){
        var next_height = this.generate_next_height(this.height_map[this.height_map.length-1])
        ...
        var tree_probability = Math.random()
        if (tree_probability < this.tree_properties.tree_probability && this.tree_timeout == 0){
            this.slope = 0.4
            var tree_scale = Math.random() * (this.tree_properties.max_scale - this.tree_properties.min_scale) + this.tree_properties.min_scale
            var tree = {
                x: this.width,
